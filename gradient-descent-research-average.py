...
def mininize(_a):
    ...
    print("value of minimizedFunc after minimization:", minimizedFunction(_a - 0.25*np.asarray(lambda_vector).dot(gradient)))
    return _a - 0.25*np.asarray(lambda_vector).dot(gradient)
